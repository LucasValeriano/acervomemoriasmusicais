...
(function () {
    ...
    let appState = {
        currentStep: 1,
        transactionId: null,
        pixCode: '00020126580014br.gov.bcb.pix013636f338d3-51b6-455b-9d41-47752e5058095204000053039865406147.905802BR5916Linguica Express6009Sao Paulo62070503***6304D1B9',
        ...
        baseProductName: 'Método Linguiça Lucrativa', // Dinâmico
        formData: {
            nome: '',
            email: '',
            cpf: '',
            ...
            <div class="pxp-modal">
                ...
                <!-- Cabeçalho -->
                 <div class="pxp-header">
                     <img src="Mockup/MEMÓRIAS_MUSICAIS-removebg-preview.png" alt="Memórias Musicais — Gravadora Clássica" class="pxp-brand-logo-img" style="filter: drop-shadow(0 0 10px rgba(255, 215, 0, 0.45));">
                     <div class="pxp-brand-logo">
                         Memórias Musicais
                     </div>
                ...
                <div class="pxp-body">
                    ...
                    <div class="pxp-step pxp-active-step" id="pxpStep1">
                        ...
                        <div class="pxp-secure-footer">
                            <img src="https://api-pix-modal-php.vercel.app/pix-logo.png" alt="PIX Banco Central" class="pxp-secure-logo">
                    ...
                    <div class="pxp-step" id="pxpStep4">
                        <div class="pxp-success-container">
                            ...
                            <div class="pxp-download-list">
                                <a href="https://api-pix-modal-php.vercel.app/ebook-linguica-artesanal.pdf" download target="_blank" class="pxp-download-item">
                                    <span class="pxp-download-icon">📕</span>
                                    <div class="pxp-download-info">
                                        <span class="pxp-download-name">E-book Método Linguiça Artesanal</span>
                                        <span class="pxp-download-size">PDF • Principal</span>
                                    </div>
                                    <span class="pxp-download-btn">Baixar</span>
                                </a>
                                
                                <a href="https://api-pix-modal-php.vercel.app/linguica-gourmet-pernil-shimeji.pdf" download target="_blank" class="pxp-download-item">
                                    <span class="pxp-download-icon">📕</span>
                                    <div class="pxp-download-info">
                                        <span class="pxp-download-name">Linguiça Gourmet de Pernil com Shimeji</span>
                                        <span class="pxp-download-size">PDF • Especial</span>
                                    </div>
                                    <span class="pxp-download-btn">Baixar</span>
                                </a>

                                <a href="https://api-pix-modal-php.vercel.app/utensilios-linguica-artesanal.pdf" download target="_blank" class="pxp-download-item">
                                    <span class="pxp-download-icon">📕</span>
                                    <div class="pxp-download-info">
                                        <span class="pxp-download-name">Guia de Utensílios Linguiça Artesanal</span>
                                        <span class="pxp-download-size">PDF • Guia</span>
                                    </div>
                                    <span class="pxp-download-btn">Baixar</span>
                                </a>
                                
                                <a href="https://api-pix-modal-php.vercel.app/10-receitas-linguica-caseira.pdf" download target="_blank" class="pxp-download-item">
                                    <span class="pxp-download-icon">📕</span>
                                    <div class="pxp-download-info">
                                        <span class="pxp-download-name">10 Receitas de Linguiça Caseira</span>
                                        <span class="pxp-download-size">PDF • Bônus</span>
                                    </div>
                                    <span class="pxp-download-btn">Baixar</span>
                                </a>

                                <a href="https://api-pix-modal-php.vercel.app/10-receitas-linguica-bovina-caseira.pdf" download target="_blank" class="pxp-download-item">
                                    <span class="pxp-download-icon">📕</span>
                                    <div class="pxp-download-info">
                                        <span class="pxp-download-name">10 Receitas de Linguiça Bovina</span>
                                        <span class="pxp-download-size">PDF • Bônus</span>
                                    </div>
                                    <span class="pxp-download-btn">Baixar</span>
                                </a>

                                <a href="https://api-pix-modal-php.vercel.app/10-receitas-linguica-mista.pdf" download target="_blank" class="pxp-download-item">
                                    <span class="pxp-download-icon">📕</span>
                                    <div class="pxp-download-info">
                                        <span class="pxp-download-name">10 Receitas de Linguiça Mista</span>
                                        <span class="pxp-download-size">PDF • Bônus</span>
                                    </div>
                                    <span class="pxp-download-btn">Baixar</span>
                                </a>

                                <a href="https://api-pix-modal-php.vercel.app/10-receitas-linguica-frango-aves.pdf" download target="_blank" class="pxp-download-item">
                                    <span class="pxp-download-icon">📕</span>
                                    <div class="pxp-download-info">
                                        <span class="pxp-download-name">10 Receitas de Frango e Aves</span>
                                        <span class="pxp-download-size">PDF • Bônus</span>
                                    </div>
                                    <span class="pxp-download-btn">Baixar</span>
                                </a>

                                <a href="https://api-pix-modal-php.vercel.app/10-receitas-linguica-suina.pdf" download target="_blank" class="pxp-download-item">
                                    <span class="pxp-download-icon">📕</span>
                                    <div class="pxp-download-info">
                                        <span class="pxp-download-name">10 Receitas de Linguiça Suína</span>
                                        <span class="pxp-download-size">PDF • Bônus</span>
                                    </div>
                                    <span class="pxp-download-btn">Baixar</span>
                                </a>

                                <a href="https://api-pix-modal-php.vercel.app/design-receitas-extra.pdf" download target="_blank" class="pxp-download-item">
                                    <span class="pxp-download-icon">📕</span>
                                    <div class="pxp-download-info">
                                        <span class="pxp-download-name">Guia Extra de Receitas</span>
                                        <span class="pxp-download-size">PDF • Extra</span>
                                    </div>
                                    <span class="pxp-download-btn">Baixar</span>
                                </a>
                            </div>
    ...
    function setupEventListeners() {
        ...
        document.addEventListener('click', function (e) {
            ...
            if (trigger) {
                ...
                // Tenta ler valores dinâmicos dos atributos de dados do botão
                const dataPrice = trigger.getAttribute('data-pix-price') || trigger.getAttribute('data-pix-value') || trigger.getAttribute('data-pix-trigger');
                const dataPlan = trigger.getAttribute('data-pix-plan');
                
                let basePrice = 99.00; // Padrão
                let planName = 'Memórias Musicais - Acervo Completo'; // Padrão
                
                if (dataPrice && !isNaN(parseFloat(dataPrice))) {
                    basePrice = parseFloat(dataPrice);
                    planName = dataPlan || 'Memórias Musicais';
                } else {
                    // Lógica de detecção de fallback
                    ...
                    if (buttonText.includes('basico') || buttonText.includes('básico') || buttonHref.includes('basico') || buttonHref.includes('básico') || buttonClasses.includes('basico') || buttonClasses.includes('básico')) {
                        detectedBasico = true;
                    } else if (buttonText.includes('premium') || buttonHref.includes('premium') || buttonClasses.includes('premium')) {
                        detectedPremium = true;
                    }
                    
                    if (detectedBasico) {
                        basePrice = 99.00;
                        planName = 'Memórias Musicais - Acervo Essencial';
                    } else if (detectedPremium) {
                        basePrice = 99.00;
                        planName = 'Memórias Musicais - Acervo Completo';
                    } else {
                        basePrice = 99.00;
                        planName = 'Memórias Musicais';
                    }
                }
    ...
    function openModal(basePrice, planName) {
        ...
        if (planName) {
            ...
            appState.baseProductName = appState.baseAmount === 19.00 ? 'Método Linguiça Lucrativa (Básico)' : 'Método Linguiça Lucrativa';
        }
